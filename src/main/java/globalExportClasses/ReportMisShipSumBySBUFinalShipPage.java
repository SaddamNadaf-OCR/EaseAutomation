...
public class ReportMisShipSumBySBUFinalShipPage extends GenericMethods {
	...
	public static final String OCR_CreatedFromDate = "//input[@id='resultShipmentSummaryBySbuFinalReport_fromCreatedDate']";
	public static final String OCR_DateToday = "//button[contains(text(),'Today')]";
	public static final String OCR_CreatedToDate = "//input[@id='resultShipmentSummaryBySbuFinalReport_toCreatedDate']";
	public static final String OCR_ExportFromDate = "//input[@id='resultShipmentSummaryBySbuFinalReport_fromDateOfExport']";
	public static final String OCR_ExportToDate = "//input[@id='resultShipmentSummaryBySbuFinalReport_toDateOfExport']";
	
	//* ******************************* Constructor ****************************** *//

	public ReportMisShipSumBySBUFinalShipPage(WebDriver driver, ExtentTest test) {
					this.driver = driver;
					this.test = test; 
			}
	/* ******************************* Action ****************************** */
	...
	public void searchByParameters(String SbuCode, String country, String UltConsName, String IntConsName,
		...
		if(Region.length() > 0) {
			deSelectAll(driver, test, "//select[@id='resultShipmentSummaryBySbuFinalReport_selectRegion']", Region);
		selectByVisibleText(driver, test, "//select[@id='resultShipmentSummaryBySbuFinalReport_selectRegion']", "Select Region : ", Region);
		}
		if(Site.length() > 0) {
			deSelectAll(driver, test, "//select[@id='resultShipmentSummaryBySbuFinalReport_selectSite']", Site);
		selectByVisibleText(driver, test, "//select[@id='resultShipmentSummaryBySbuFinalReport_selectSite']", "Select site : ", Site);
		}
