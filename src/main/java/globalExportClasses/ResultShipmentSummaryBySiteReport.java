...
public class ResultShipmentSummaryBySiteReport extends GenericMethods {
	...
	public ResultShipmentSummaryBySiteReport(WebDriver driver, ExtentTest test) {
		this.driver = driver;
		this.test = test; 
    }
    ...
    public void titleIsDisplayed() {
        try {
            if(isDisplayed(driver, Report)) {
                test.log(LogStatus.PASS, "Title is Displayed : SHIPMENT SUMMARY BY SITE REPORT");
            }
        } catch (Exception e) {
            testFailSshot(driver, test);
            test.log(LogStatus.FAIL, "Title is not Displayed : SHIPMENT SUMMARY BY SITE REPORT");
        }
    }
