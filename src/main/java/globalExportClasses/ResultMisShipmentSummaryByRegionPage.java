...
public class ResultMisShipmentSummaryByRegionPage extends GenericMethods {
	...
	public ResultMisShipmentSummaryByRegionPage(WebDriver driver, ExtentTest test) {
		this.driver = driver;
		this.test = test; 
    }
	/* ******************************* Action ****************************** */
    ...
    public void titleIsDisplayed() {
        try {
            if(isDisplayed(driver, Report)) {
                test.log(LogStatus.PASS, "Title is Displayed : SHIPMENT SUMMARY BY REGION REPORT");
            }
        } catch (Exception e) {
            testFailSshot(driver, test);
            test.log(LogStatus.FAIL, "Title is not Displayed : SHIPMENT SUMMARY BY REGION REPORT");
        }
    }
