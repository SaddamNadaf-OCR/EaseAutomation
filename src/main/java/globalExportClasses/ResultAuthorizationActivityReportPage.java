...
public class ResultAuthorizationActivityReportPage extends GenericMethods {
	...
	public ResultAuthorizationActivityReportPage(WebDriver driver, ExtentTest test) {
		this.driver = driver;
		this.test = test; 
    }
	/* ******************************* Action ****************************** */
