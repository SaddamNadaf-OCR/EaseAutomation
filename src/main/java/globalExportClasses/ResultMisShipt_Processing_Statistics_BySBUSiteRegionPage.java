...
public class ResultMisShipt_Processing_Statistics_BySBUSiteRegionPage extends GenericMethods {
	...
	public static final String Report  = "//h3[contains(text(),'SHIPMENT PROCESSING STATISTICS BY SBU REPORT')]";
	...
	public ResultMisShipt_Processing_Statistics_BySBUSiteRegionPage(WebDriver driver, ExtentTest test) {
		this.driver = driver;
		this.test = test; 
    }
	/* ******************************* Action ****************************** */
    ...
    public void titleIsDisplayed() {
        try {
            if(isDisplayed(driver, Report)) {
                test.log(LogStatus.PASS, "Title is Displayed : SHIPMENT PROCESSING STATISTICS BY SBU REPORT");
            }
        } catch (Exception e) {
            testFailSshot(driver, test);
            test.log(LogStatus.FAIL, "Title is not Displayed : SHIPMENT PROCESSING STATISTICS BY SBU REPORT");
        }
    }
