...
public class ResultMisDisapprovalMetricsPage extends GenericMethods {
	...
	public ResultMisDisapprovalMetricsPage(WebDriver driver, ExtentTest test) {
		this.driver = driver;
		this.test = test; 
    }
	/* ******************************* Action ****************************** */
    ...
    public void titleIsDisplayed() {
        try {
            if(isDisplayed(driver, Report)) {
                test.log(LogStatus.PASS, "Title is Displayed : Search Cancelled\\Disapproved\\Returned Shipment Metrics By SBU");
            }
        } catch (Exception e) {
            testFailSshot(driver, test);
            test.log(LogStatus.FAIL, "Title is not Displayed : Search Cancelled\\Disapproved\\Returned Shipment Metrics By SBU");
        }
    }
