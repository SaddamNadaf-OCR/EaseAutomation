...
public class NrcWebServiceAuditReportPage extends GenericMethods {
	...
	/* ******************** Constructor ***************************** */
	public NrcWebServiceAuditReportPage(WebDriver driver, ExtentTest test) {
	...
	public void webserviceAuditReportDisplayOfTitle() {
		try {
			if (isDisplayed(driver, "//h3[contains(text(),'Result Web Service Audit Report')]")) {
