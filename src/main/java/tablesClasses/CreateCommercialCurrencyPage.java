...
public class CreateCommercialCurrencyPage extends GenericMethods {
...
// -------------------------------------------Constructor-----------------------------------------//
	...
	public CreateCommercialCurrencyPage(WebDriver driver, ExtentTest test) {
		this.driver = driver;
		this.test = test;
	}
	
	//--------------------------Code------------------------------------------------//
	public void enter_Code(String CurrencyFrom, String CurrencyTo, String ConversionRate, String ValidFrom, String ValidTo) {
		Wait.waitfor(3);
