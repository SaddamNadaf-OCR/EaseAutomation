...
public class SearchCargoReleasePage extends GenericMethods {
	...
	public static final String OCR_AddNewCR_ClickAddNew = "//button[contains(text(),'Add New')]";
	...
	public SearchCargoReleasePage(WebDriver driver, ExtentTest test) {
		this.driver = driver;
		this.test = test;
	}
	...
	// Click on Add new
	public void addNew() {
		clickElement(driver, test, OCR_AddNewCR_ClickAddNew, "click on addnew");
	}
