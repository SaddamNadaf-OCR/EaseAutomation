...
public class AnnualStatusDelinquencyReportPage extends GenericMethods{
	...
	public static final String AuthMana_Report_SearchCriteria="//h3[contains(text(),'Annual Status Delinquency Report')]";
	public static final String ResultAuth_ResultAuthorization="//h3[@class='page-heading']";
	
	//..................................Constructors..................................//
	public AnnualStatusDelinquencyReportPage(WebDriver driver,ExtentTest test) {
		this.driver = driver;
		this.test = test;
	}
