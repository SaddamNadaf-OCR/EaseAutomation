...
public class SearchLicenseExceptionSummary extends GenericMethods{
	...
	//..................................Constructors..................................//
	public SearchLicenseExceptionSummary(WebDriver driver,ExtentTest test) {
		this.driver = driver;
		this.test = test;
	}
	...
	public void searchByAllParameters(String SBUCode, String ShipmentWorkStatus, String Exemption, String ExemptionDescription, 
			...
			String SalesOrderNo, String ECCNCategory, String UltimateConsignee, String CountrysOfUltDestination, String PartNo) {
