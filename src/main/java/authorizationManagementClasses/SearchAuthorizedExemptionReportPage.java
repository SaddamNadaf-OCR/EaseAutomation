...
public class SearchAuthorizedExemptionReportPage extends GenericMethods{
	...
	//..................................Constructors..................................//
	public SearchAuthorizedExemptionReportPage(WebDriver driver,ExtentTest test) {
		this.driver = driver;
		this.test = test;
	}
	...
	public void searchByAllParameters(String SBUCode, String AuthorizationNo, String Exception, String Program, 
			String EndUser, String Country, String ECCNUSML, String SortBy, String direction) {
