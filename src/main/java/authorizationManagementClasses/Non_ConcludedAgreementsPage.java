...
public class Non_ConcludedAgreementsPage extends GenericMethods{
	...
	public static final String AuthMana_Report_SearchCriteria="//h3[contains(text(),'Non-Concluded Agreements')]";
	public static final String ResultAuth_ResultAuthorization="//h3[@class='page-heading']";
	
	//..................................Constructors..................................//
	public Non_ConcludedAgreementsPage(WebDriver driver,ExtentTest test) {
		this.driver = driver;
		this.test = test;
	}
