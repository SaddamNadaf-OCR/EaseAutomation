...
public class SearchOwnerDiscrepancyReportPage extends GenericMethods{
	...
	public static final String AuthMana_Report_NotifyDateFrom = "//input[@name='notifyStartDate']";
	public static final String AuthMana_Report_NotifyDateTo = "//input[@name='notifyEndDate']";
	...
	//..................................Constructors..................................//
	public SearchOwnerDiscrepancyReportPage(WebDriver driver,ExtentTest test) {
		this.driver = driver;
		this.test = test;
	}
	...
	public void searchByParameters(String SBUCode, String AuthorizationType, String TransactionID, String AuthorizationNo, 
			String Status, String Owner, String POC, String Purpose, String ProductLine, String ProductFamily, String NotifyDateFrom, 
			String NotifyDateTo, String SortBy, String Direction) {
		...
		if(NotifyDateFrom.length() > 0) {
			clickElement(driver, test, AuthMana_Report_NotifyDateFrom, "Clicking on Notify Date From :");
			dateOfMonthName(driver, test, "Selecting Notify Date From :", NotifyDateFrom);
		}
		if(NotifyDateTo.length() > 0) {
			clickElement(driver, test, AuthMana_Report_NotifyDateTo, "Clicking on Notify Date to :");
			dateOfMonthName(driver, test, "Selecting Notify Date To :", NotifyDateTo);
		}
