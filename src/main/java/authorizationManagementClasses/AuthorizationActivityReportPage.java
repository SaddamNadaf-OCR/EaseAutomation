 ...
 * Descriptions : Authorization Activity Report Page
 * changed by : Nil
 * changed date : Nil
...
public class AuthorizationActivityReportPage extends GenericMethods {
	...
	public static final String AuthMana_Report_ActivityType = "//select[@id='resultActivityReport_licenseTransaction_activityType']";
	...
	// ..................................Constructors..................................//
	public AuthorizationActivityReportPage(WebDriver driver, ExtentTest test) {
		this.driver = driver;
		this.test = test;
	}
	...
	public void searchByParameters(String SBUCode, String Status, String ActivityType, String AuthorizationType,
			String AuthorizationNo, String OriginatingTransaction, String ReferanceNo, String EntryNo, String PartyName,
			String TransactionDateFrom, String TransactionDateTo, String ExpiryDateFrom, String ExpiryDateTo,
			String CountryShippedFrom, String PortOfExport, String CountryShippedTo, String PortOfImport, String PartNo,
			String SerialNo, String ExportClassification, String ImportClassification, String TravelerName,
			String ExportShipmentNo, String ExpiresIn, String IncludeLicense, String Program, String Segment,
			String Site, String Region, String OrderNo, String SortBy, String Direction) {
		...
		if (AuthorizationType.length() > 0) {
			...
			try {
				typeText(driver, test, AuthMana_Report_AuthorizationTypePopup, "Entering Authorization Type :",
						AuthorizationType);
				clickElement(driver, test, AuthMana_Report_SearchPopup, "Clicking on Search Button :");
				mouseOverAndClick(driver, test, "//td[contains(text(),'" + AuthorizationType + "')]",
			...
			typeText(driver, test, AuthMana_Report_AuthorizationTypeTextbox, "Entering Authorization Type :",
					AuthorizationType);
		}
		if (AuthorizationNo.length() > 0) {
			clickElement(driver, test, AuthMana_Report_AuthorizationNo, "Clicking on Authorization No :");
			try {
				typeText(driver, test, AuthMana_Report_AuthorizationtNoPopup, "Entering Authorization No :",
						AuthorizationNo);
				clickElement(driver, test, AuthMana_Report_SearchPopup, "Clicking on Search Button :");
				mouseOverAndClick(driver, test, "//td[contains(text(),'" + AuthorizationNo + "')]",
						"Selecting Authorization No :");
				clickElement(driver, test, AuthMana_Report_SelectPopup, "Clicking on Select Button :");
			} catch (Exception e) {
				testFailSshot(driver, test);
				e.printStackTrace();
			...
			typeText(driver, test, AuthMana_Report_AuthorizationNoTextbox, "Entering Authorization No :",
					AuthorizationNo);
		}
		if (OriginatingTransaction.length() > 0) {
			selectByVisibleText(driver, test, AuthMana_Report_OriginatingTransaction,
					"Selecting Originating Transaction :", OriginatingTransaction);
		}
		...
		if (CountryShippedFrom.length() > 0) {
			typeText(driver, test, AuthMana_Report_CountryShippedFrom, "Entering Country Shipped From :",
					CountryShippedFrom);
		}
		if (PortOfExport.length() > 0) {
			...
			try {
				...
				clickElement(driver, test, AuthMana_Report_SearchPopup, "Clicking on Search Button :");
				mouseOverAndClick(driver, test, "//td[contains(text(),'" + PortOfExport + "')]",
						"Selecting Port Of Export :");
				clickElement(driver, test, AuthMana_Report_SelectPopup, "Clicking on Select Button :");
			} catch (Exception e) {
				testFailSshot(driver, test);
				e.printStackTrace();
		...
		if (PortOfImport.length() > 0) {
			...
			try {
				...
				clickElement(driver, test, AuthMana_Report_SearchPopup, "Clicking on Search Button :");
				mouseOverAndClick(driver, test, "//td[contains(text(),'" + PortOfImport + "')]",
						"Selecting Port Of Import :");
				clickElement(driver, test, AuthMana_Report_SelectPopup, "Clicking on Select Button :");
			} catch (Exception e) {
				testFailSshot(driver, test);
				e.printStackTrace();
		...
		if (ExportClassification.length() > 0) {
			...
			try {
				typeText(driver, test, AuthMana_Report_ECCNUSMLPopup, "Entering Export Classification :",
						ExportClassification);
				clickElement(driver, test, AuthMana_Report_SearchPopup, "Clicking on Search Button :");
				mouseOverAndClick(driver, test, "//td[contains(text(),'" + ExportClassification + "')]",
						"Selecting Export Classification :");
				clickElement(driver, test, AuthMana_Report_SelectPopup, "Clicking on Select Button :");
			} catch (Exception e) {
				testFailSshot(driver, test);
				e.printStackTrace();
			...
			typeText(driver, test, AuthMana_Report_ExportClassificationTextbox, "Entering Export Classification :",
					ExportClassification);
		}
		if (ImportClassification.length() > 0) {
			...
			try {
				typeText(driver, test, AuthMana_Report_HSNoPopup, "Entering Import Classification :",
						ImportClassification);
				clickElement(driver, test, AuthMana_Report_SearchPopup, "Clicking on Search Button :");
				mouseOverAndClick(driver, test, "//td[contains(text(),'" + ImportClassification + "')]",
						"Selecting Import Classification :");
				clickElement(driver, test, AuthMana_Report_SelectPopup, "Clicking on Select Button :");
			} catch (Exception e) {
				testFailSshot(driver, test);
				e.printStackTrace();
			...
			typeText(driver, test, AuthMana_Report_ImportClassificationTextbox, "Entering Import Classification :",
					ImportClassification);
		}
		if (TravelerName.length() > 0) {
			...
			try {
				...
				clickElement(driver, test, AuthMana_Report_SearchPopup, "Clicking on Search Button :");
				mouseOverAndClick(driver, test, "//td[contains(text(),'" + TravelerName + "')]",
						"Selecting Traveler Name :");
				clickElement(driver, test, AuthMana_Report_SelectPopup, "Clicking on Select Button :");
			} catch (Exception e) {
				testFailSshot(driver, test);
				e.printStackTrace();
		...
		if (IncludeLicense.length() > 0) {
			selectByVisibleText(driver, test, AuthMana_Report_IncludeLicense, "Selecting Include License :",
					IncludeLicense);
		}
		if (Program.length() > 0) {
