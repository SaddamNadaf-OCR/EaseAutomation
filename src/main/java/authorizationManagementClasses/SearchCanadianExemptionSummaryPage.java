...
public class SearchCanadianExemptionSummaryPage extends GenericMethods{
	...
	public static final String AuthMana_Report_CanadianExemptionNo ="//select[@name='selectItarExemptionNo']";
	public static final String AuthMana_Report_ShipmentWorkStatus="//select[@name='selectShipmentWorkStatus']";
	public static final String AuthMana_Report_CountryofUltimateDestination = "//select[@name='selectCountryOfUltDest']";
	public static final String AuthMana_Report_CanadianExemptionDescription="//input[@name='itarExemptionName']";
	...
	public static final String AuthMana_Report_ECCN_ExporterName="//input[@name='shipment.exporterContactName']";
	...
	public void searchByAllParameters(String SBUCode, String CanadianExemptionNo, String ShipmentWorkStatus, String CountryofUltimateDestination, 
			String CanadianExemptionDescription, String DateOfExportFrom, String DateOfExportTo, String ExporterCode, 
			String ExporterName, String shipmentNo, String SalesOrderNo, String USMLCategory, String UltimateConsignee, String PartNo) {
		
		selectByVisibleText(driver, test, AuthMana_Report_SbuCode, "Selecting SBU Code", SBUCode);
		selectByVisibleText(driver, test, AuthMana_Report_CanadianExemptionNo, "Selecting Canadian Exemption No :", CanadianExemptionNo);
		selectByVisibleText(driver, test, AuthMana_Report_ShipmentWorkStatus, "Selecting Shipment Work Status :", ShipmentWorkStatus);
		selectByVisibleText(driver, test, AuthMana_Report_CountryofUltimateDestination, "Selecting Country of Ultimate Destination :", CountryofUltimateDestination);
		typeText(driver, test, AuthMana_Report_CanadianExemptionDescription, "Entering Canadian Exemption Description :", CanadianExemptionDescription);
		...
		typeText(driver, test, AuthMana_Report_ECCN_ExporterName, "Entering Exporter Name :", ExporterName);
