...
public class SearchTransactionsMeetingPart130Page  extends GenericMethods{
	...
	public static final String AuthMana_Report_Part130POC ="//a[contains(text(),'Part 130 POC')]";
	public static final String AuthMana_Report_Part130POCTextbox="//input[@name='dosGeneralInfo.part130Poc']";
	
	//..................................Constructors..................................//
	public SearchTransactionsMeetingPart130Page(WebDriver driver,ExtentTest test) {
		this.driver = driver;
		this.test = test;
	}
	...
	public void searchByAllParameters(String SBUCode, String FormType, String Status, String selectCompliance, String TransactionID,
			...
			String EmpoweredOfficial, String Part130POC) {
		...
		if(Part130POC.length() > 0) {
			clickElement(driver, test, AuthMana_Report_Part130POC, "Clicking on Part 130 POC :");
			try {
				Wait.waitfor(3);
				typeText(driver, test, AuthMana_Report_UserFirstName, "Entering Part 130 POC :", Part130POC);
				Wait.waitfor(3);
				clickElement(driver, test, AuthMana_Report_SearchPopUp, "Clicking on Search Tab :");
				Wait.waitfor(3);
				mouseOverAndClick(driver, test, "//td[contains(text(),'"+Part130POC+"')]", "Selecting Part 130 POC :");
				Wait.waitfor(3);
				clickElement(driver, test, AuthMana_Report_SelectPopUp, "Clicking on Select tab");
			} catch (Exception e) {
				e.printStackTrace();
			...
			typeText(driver, test, AuthMana_Report_Part130POCTextbox, "Entering Part 130 POC :", Part130POC);
		}
	}
}