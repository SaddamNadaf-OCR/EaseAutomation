...
public class WASSENAARSEMIANNUALREPORTPage extends GenericMethods{
	...
	public static final String GotoNextPage = "//img[@src='data/img/next_grey.GIF']";
	public static final String GotoLastPage = "//img[@src='data/img/last_grey.GIF']";
	public static final String EnterPgNum = "//input[@id='pageId']";
	public static final String GoBtn = "//img[@src='data/img/go.png']";
	
	//...................................Constructors............................................//
	public WASSENAARSEMIANNUALREPORTPage(WebDriver driver,ExtentTest test) {
		this.driver = driver;
		this.test = test;
	}
