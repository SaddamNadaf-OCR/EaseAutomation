...
public class AuthorizationAgainstAgreementReportPage extends GenericMethods{
	...
	public static final String AuthMana_Report_SearchCriteria="//h3[contains(text(),'Authorization Against Agreement Report')]";
	public static final String ResultAuth_ResultAuthorization="//h3[@class='page-heading']";
	
	//..................................Constructors..................................//
	public AuthorizationAgainstAgreementReportPage(WebDriver driver,ExtentTest test) {
		this.driver = driver;
		this.test = test;
	}
		...
		public void titleIsDisplayed() {
			try {
				if(isDisplayed(driver, ResultAuth_ResultAuthorization)) {
					test.log(LogStatus.PASS, "Title is Displayed : Authorization Against Agreement Report Page ");
				}
			} catch (Exception e) {
				testFailSshot(driver, test);
				test.log(LogStatus.FAIL, "Title is not Displayed : Authorization Against Agreement Report Page ");
			}
		} 
}
