...
public class SearchSemiAnnualDelinquencyReportPage extends GenericMethods{
	...
	//..................................Constructors..................................//
	public SearchSemiAnnualDelinquencyReportPage(WebDriver driver,ExtentTest test) {
		this.driver = driver;
		this.test = test;
	}
	...
	public void searchByAllParameters(String SBUCode, String TransactionID, String AthorizationNumber, String FormType, String Status, String Programme, String Segment, String ProductLine, String ProductFamily, String reportYear, String SortBy, String direction) {
		...
		if(AthorizationNumber.length() > 0) {
			clickElement(driver, test, AuthMana_Report_AuthorizationNo, "Clicking on Athorization Number");
			try {
				Wait.waitfor(3);
				typeText(driver, test, "//input[@name='dosGeneralInfoDTO.licenseNo']", "Entering Athorization Number :", AthorizationNumber);
				Wait.waitfor(3);
				clickElement(driver, test, AuthMana_Report_SearchPopUp, "Clicking on Search Tab");
				Wait.waitfor(3);
				mouseOverAndClick(driver, test, "//td[contains(text(),'"+AthorizationNumber+"')]", "Selecting Athorization Number :");
				Wait.waitfor(3);
				clickElement(driver, test, AuthMana_Report_SelectPopUp, "Clicking on Select tab");
			} catch (Exception e) {
				e.printStackTrace();
			...
			typeText(driver, test, AuthMana_Report_TransactionIDTextBox, "Entering Athorization Number", AthorizationNumber);
		}
