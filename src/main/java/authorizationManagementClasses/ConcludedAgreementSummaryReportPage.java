...
public class ConcludedAgreementSummaryReportPage extends GenericMethods{
	...
	public static final String AuthMana_Report_SearchCriteria="//h3[contains(text(),'Concluded Agreement Summary Report')]";
	public static final String ResultAuth_ResultAuthorization="//h3[@class='page-heading']";
	
	//..................................Constructors..................................//
	public ConcludedAgreementSummaryReportPage(WebDriver driver,ExtentTest test) {
		this.driver = driver;
		this.test = test;
	}
