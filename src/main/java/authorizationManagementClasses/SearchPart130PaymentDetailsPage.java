...
public class SearchPart130PaymentDetailsPage extends GenericMethods{
	...
	//..................................Constructors..................................//
	public SearchPart130PaymentDetailsPage(WebDriver driver,ExtentTest test) {
		this.driver = driver;
		this.test = test;
	}
	...
	public void searchByAllParameters(String SBUCode, String Part130RefID, String Status, String POA, String ContactNo, 
			String Recipient, String AgreementNo, String Country, String ReportYes, String ReportNo, String SubmittedDateFrom, 
			String SubmittedDateTo, String Programme, String Segment, String Site, String Department, String SortBy, String Direction) {
