...
public class SublicenseeSummaryReportPAge extends GenericMethods{
	...
	public static final String AuthMana_Report_SearchCriteria="//h3[contains(text(),'Sublicensee Summary Report')]";
	public static final String ResultAuth_ResultAuthorization="//h3[@class='page-heading']";
	
	//..................................Constructors..................................//
	public SublicenseeSummaryReportPAge(WebDriver driver,ExtentTest test) {
		this.driver = driver;
		this.test = test;
	}
