...
public class SearchAnnualSalesDelinquencyReportPage extends GenericMethods{
	...
	//..................................Constructors..................................//
	public SearchAnnualSalesDelinquencyReportPage(WebDriver driver,ExtentTest test) {
		this.driver = driver;
		this.test = test;
	}
	...
	public void searchBYParameters(String SBUCode, String TransactionID, String AuthorizationType, String Status,
			...
			String Segment, String Company, String ProductLine, String ProductFamily, String SalesReportYear,
