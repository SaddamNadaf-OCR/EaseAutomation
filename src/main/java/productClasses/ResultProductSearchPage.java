...
public class ResultProductSearchPage extends GenericMethods {
		...
		public ResultProductSearchPage(WebDriver driver, ExtentTest test) {
			this.driver = driver;
			this.test = test;
		}
		...
		public void edit_product() {
			clickElement(driver, test, "//a[@class='pName-tooltip']", "Clicking on Part No Link: ");
		}
