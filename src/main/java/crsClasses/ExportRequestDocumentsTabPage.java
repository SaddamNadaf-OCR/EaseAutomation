...
public class ExportRequestDocumentsTabPage extends GenericMethods {
	...
	public static final String OCR_ExportRequestAddDocpopUpSavendReturnBtn = "//button[@id='saveButton']";
	...
	/************************* constructor ***********************/
	public ExportRequestDocumentsTabPage(WebDriver driver, ExtentTest test) {
		this.driver = driver;
		this.test = test;
	}
