...
public class ResultSearchTravelDebriefDelinquencyReportPage extends GenericMethods{
	...
	//..................................Constructors..................................//
	public ResultSearchTravelDebriefDelinquencyReportPage(WebDriver driver,ExtentTest test) {
		this.driver = driver;
		this.test = test;
	}
    ...
    public void titleIsDisplayed() {
        try {
            if(isDisplayed(driver, CRS_Reports_Heading)) {
                test.log(LogStatus.PASS, "Title is Displayed : Results Completed Search Travel Debrief Delinquency Report");
            }
        } catch (Exception e) {
            testFailSshot(driver, test);
            test.log(LogStatus.FAIL, "Title is not Displayed : Results Completed Search Travel Debrief Delinquency Report");
        }
    }
}
