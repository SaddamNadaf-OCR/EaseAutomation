...
public class AGRResultTemplatePage extends GenericMethods{
	
	public WebDriver driver;
	public ExtentTest test;
	
	//.........................................Locators................................................//
	public static final String AGR_Template_CopyIcon = "//i[@class='fa fa-copy']";
	public static final String AGR_Template_ResultGrid = "//div[@id='gbox_grid']";
	public static final String AGR_Template_ResultPage = "//h3[@class='page-heading']";
	//...........................................Constructor....................................................//
	public AGRResultTemplatePage(WebDriver driver,ExtentTest test) {
		this.driver=driver;
		this.test=test;
	}
	...
	public void copyIcon() {
		clickElement(driver, test, AGR_Template_CopyIcon, "Clicking on Copy Icon :");
		Wait.waitfor(6);
	...
	public void GridisDisplayed() {
		try {
	           if(isDisplayed(driver, AGR_Template_ResultGrid)) {
	               test.log(LogStatus.PASS, "Grid is Displayed : Agreement Request Template Search Page :");
	           }
	       } catch (Exception e) {
	           testFailSshot(driver, test);
	           test.log(LogStatus.FAIL, "Grid is not Displayed : Agreement Request Template Search Page :");
	       }
	}
}