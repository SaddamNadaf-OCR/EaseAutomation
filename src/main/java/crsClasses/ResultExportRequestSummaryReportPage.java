...
public class ResultExportRequestSummaryReportPage extends GenericMethods{
	...
	//..................................Constructors..................................//
	public ResultExportRequestSummaryReportPage(WebDriver driver,ExtentTest test) {
		this.driver = driver;
		this.test = test;
	}
    ...
    public void titleIsDisplayed() {
        try {
            if(isDisplayed(driver, CRS_Reports_Heading)) {
                test.log(LogStatus.PASS, "Title is Displayed : Results Export Request Summary Report");
            }
        } catch (Exception e) {
            testFailSshot(driver, test);
            test.log(LogStatus.FAIL, "Title is not Displayed : Results Export Request Summary Report");
        }
    }
