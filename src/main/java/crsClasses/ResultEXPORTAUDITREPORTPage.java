...
public class ResultEXPORTAUDITREPORTPage extends GenericMethods{
	...
	//..................................Constructors..................................//
	public ResultEXPORTAUDITREPORTPage(WebDriver driver,ExtentTest test) {
		this.driver = driver;
		this.test = test;
	}
    ...
    public void titleIsDisplayed() {
        try {
            if(isDisplayed(driver, CRS_Reports_Heading)) {
                test.log(LogStatus.PASS, "Title is Displayed : Results EXPORT AUDIT REPORT");
            }
        } catch (Exception e) {
            testFailSshot(driver, test);
            test.log(LogStatus.FAIL, "Title is not Displayed : Results EXPORT AUDIT REPORT");
        }
    }
