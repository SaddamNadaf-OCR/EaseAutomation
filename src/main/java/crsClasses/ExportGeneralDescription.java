...
public class ExportGeneralDescription extends GenericMethods {
	...
	public ExportGeneralDescription(WebDriver driver, ExtentTest test) {
		this.driver = driver;
		this.test = test;
	}
	...
	public void select_Site(String SiteId) {
		try {
			if (SiteId.length() > 0) {
				...
				clickElement(driver, test, SitId, "Select the Exporter Code : " + SiteId);
	...
	public void select_Program(String Program) {
		try {
			if (Program.length() > 0) {
				...
				clickElement(driver, test, Prog, "Select a Program : " + Program);
	...
	public void select_ProductFamily(String ProductFamily) {
		try {
			if (ProductFamily.length() > 0) {
				...
				clickElement(driver, test, ProductF, "Select product family : " + ProductFamily);
	...
	public void select_ProductLines(String ProductLines) {
		try {
			if (ProductLines.length() > 0) {
				...
				clickElement(driver, test, ProductL, "Select Product Line : " + ProductLines);
