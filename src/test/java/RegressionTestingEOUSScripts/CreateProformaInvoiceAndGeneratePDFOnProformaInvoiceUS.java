...
public class CreateProformaInvoiceAndGeneratePDFOnProformaInvoiceUS extends SeleniumTestBase {

	@DataProvider
	public Object[][] getData() {
		return Utility.getData("CreateProformaInv", excel);
	}

	@Test(dataProvider = "getData")
	public void ProformaInvoiceOrder(String Testcase, String RunMode, String SBU, String SBUCode, String orderNo,
			String AssignedTo, String OrderTitle, String ExportDate, String ultDest, String ModeOfTransport,
			String Program, String Segment, String Site, String ChargeNo, String ContractNo, String OrderCategory,
			String Priority, String RMANo, String SalesOrderNo, String SalesOrderDate, String CustOrderNo,
			String CustOrderDate, String LOC, String LOCExpiryDate, String NotifyParty, String Payment,
			String PaymentText, String Incoterms, String IncotermPlace, String BillTo, String BillToCode,
			String BillStatus, String ShipTo, String ShipToCode, String ShipStatus, String FreightForwarder,
			String FrghtFwdCode, String FFStatus, String ChargeDesc, String Amount, String ChargingAccnt, String GLA,
			String containerID, String SealNo, String ConsoPackNo, String RadioActAmnt, String DryIceQty,
			String GrossCartWt, String PackType, String Model, String TareWt, String DimensionUOM,
			String LenghtWidthHight, String WeightUOM, String GrossNet, String SKU, String Class, String BOLText,
			String PackId, String ContainerID, String NoOfPack, String TypeOfPack, String UnitPrice, String COO,
			String PartNo, String PartNum, String Desc, String SourceSystemPartNumber, String POLineNo,
			...
			String MTFNumber, String Remarks, String OrgPONo, String CustomsInvoiceQuantity, String QuantityUOM,
			String ItemUnitPrice, String ItemUnitPriceCurrency, String RepairValue, String DiscountRate,
			String WholesaleRate, String ControllingAgency, String ExportClassification, String HTS, String PrimaryUOM,
			String AuthNo, String AuthItemNo, String AuthType, String AuthTxnType, String AuthExpiryDate,
			String SMEIndicator, String HUContainerID, String HUNo, String HSLevel, String GrossWt, String NetWt,
			String MarkNos, String Dimension, String UOM, String NoPack, String AltUOM, String Skids, String length,
			String width, String height, String Factor, String Cubic, String BatchNo, String BatchCOO, String BatchQty,
			String BatchExpiryDate, String BatchSterilityDate, String ImportShipType, String ImportInvNo,
			String ImportIDNo, String DueDate, String DutyReliefType, String inboundType, String ItemNo,
			String ReliefActivityType, String PackNote, String ContractNote, String OracleAttachment,
			String DelAttachment, String EmailGroup, String EmailDocumentTo, String emailID) {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					Create_NInv.invoice_Details(orderNo, AssignedTo, OrderTitle, ExportDate, ultDest, ModeOfTransport);
					...
					// Invoice_Create_NO_Item.additionalAuthInfo(AdditionalAuthNo,
					// AdditionalAuthItemNo, AuthTransType,
...
//					InvoiceInstructionDetails.addInstructions(InvoiceInstructions, InvoiceInstNote, InvoiceItemHeader,
//							InvoiceItemFooter, InvoicePackingDetails, InvoicePackingSheetNo,
//							InvoiceNumberofPackingSheets, IRequestorUserName, IRequestorUserTitle, IRequestorTelephone,
//							IRequestorEmail, IRequestorPickedBy, IRequestorLoadedBy, IRequestorCustomerServiceRep,
//							INNotes);
...
//					InvoiceInstructionDetails.orderForm();
					...
					orderForm.Click_GenerateDocument();
					Wait.waitfor(2);
					orderForm.validateDocument(EmailGroup, EmailDocumentTo);
					Wait.waitfor(2);
					orderForm.clickSendEmailWithAttachment(emailID);
					Wait.waitfor(2);
					orderForm.scrollToInvNo();
