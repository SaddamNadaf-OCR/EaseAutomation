...
public class VerifyLSScreeningOfInvItemWithEAR99US extends SeleniumTestBase{
	
	@DataProvider
	public Object[][] getData() {
		return Utility.getData("VerifyLSEAR99Inv", excel);
	}

	@Test(dataProvider = "getData")
	public void VerifyInvItemLicenseScreeningEAR99(String Testcase, String RunMode, String SBU, String SBUCode,
			...
			String RepairValue, String DiscountRate, String WholesaleRate) {
...
//					
					...
					Invoice_Create_NO_Item.verifyNLR();
