...
public class CreateNewDeliveryOrderTransactionUS extends SeleniumTestBase {
	...
	public void deliveryOrder(String Testcase, String RunMode, String SBU, String SBUCode, String OrderNo,
			String UserFirstName, String UltDestination, String ModeOfTransport, String Program, String EntityType,
			...
			String LenghtWidthHight, String WeightUOM, String GrossNet, String ProductDescription, String CustomsInvoiceQuantity,String InoviceUOM,
			...
			String ImportHTS, String ImportUOM, String AdditionalAuthorisationNo, String AdditionalAuthorisationItemNo,
			String HUNoContainerID, String BatchNumber, String BatchInfoCountryOfOrigin,
			String SearchHazardClassorDivision) throws Exception {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					createNewDO.addProgram(Program);
			...
			//		item.AddGeneralInformation(PartNo, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "");
					item.addProductDescription(ProductDescription);
					item.addQuantityAndPricingInfo(CustomsInvoiceQuantity, InoviceUOM, "", "", RepairValue, DiscountRate, "");
					item.addClassifacationInfoUS(ControllingAgencycode, ExportClassificationItem, HtsAndPrimaryUMO,
							SecondaryCustomsQuantity, SecondaryCustomsQuantityUOM, ImportHTS, ImportUOM);
