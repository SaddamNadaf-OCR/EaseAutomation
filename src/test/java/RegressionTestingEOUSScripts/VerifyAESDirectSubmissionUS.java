...
public class VerifyAESDirectSubmissionUS extends SeleniumTestBase {

	@DataProvider
	public Object[][] getData() {
		return Utility.getData("AESDirectSubmission", excel);
	}
	...
	public void AESDirectSubmission(String Testcase, String RunMode, String SBU, String SBUCode, String ExportCode,
			...
			String Cancelled, String uname, String password, String rejected) {
...
//					EEI.searchEEI(SBUCode, ExportCode, ShipmentWorkStatus, "", "", "", "");
					...
					createEEIT.validate_AESSubmitLink();
					createEEIT.validate_AESWeblink();
					createEEIT.click_AESSubmitLink();
					createEEIT.AESButtonDisplayed();
					createEEIT.AESClose();
					...
					EEI.clickSearch();
					ResultEEI.click_ShipNumber();
					createEEIT.AESRejected(rejected);
					createEEIT.Savebutton();
