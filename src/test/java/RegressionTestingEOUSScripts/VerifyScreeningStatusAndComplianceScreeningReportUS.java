...
public class VerifyScreeningStatusAndComplianceScreeningReportUS extends SeleniumTestBase {

	@DataProvider
	public Object[][] getData() {
		return Utility.getData("VerifyScreeningStatus", excel);
	}

	@Test(dataProvider = "getData")
	public void CopyInvFromApprovedInvoice(String Testcase, String RunMode, String SBU, String InvoiceNo, String workStatus) {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					ResultInv.clickReport();
					ResultInv.transactionScreeningSummaryDisplayed();
					ResultInv.transactionScreeningPopUpClose();
					ResultInv.clickInvoiceNo();
					
				EditInvoiceOrder.clickCompSummReportIcon();
				EditInvoiceOrder.clickCloseBtnTransacSummReport();
