...
public class CreateHoldTypesUS extends SeleniumTestBase{
	
	@DataProvider
	public Object[][] getData() {
		return Utility.getData("CreateHoldTypes", excel);
	}

	@Test(dataProvider = "getData")
	public void CreateHoldTypes(String Testcase, String RunMode, String SBU, String SBUCode, String HoldName, String Description) {
