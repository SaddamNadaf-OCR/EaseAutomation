...
public class VerifyCopyFuncOfInBondCodeUS extends SeleniumTestBase{
	
	@DataProvider
	public Object[][] getData() {
		return Utility.getData("CopyInBondCode", excel);
	}

	@Test(dataProvider = "getData")
	public void CopyInBondCode(String Testcase, String RunMode, String SBU, String InBondCode) {
