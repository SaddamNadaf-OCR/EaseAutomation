...
public class AddMasterAirwaybillUS extends SeleniumTestBase {
	@DataProvider
	public Object[][] getData() {
		return Utility.getData("AddMasterAirwaybill", excel);
	}
	@Test(dataProvider = "getData")
	public void addMasterAirwaybill (String Testcase, String RunMode, String MAWBNO, String FFCODE, String ConsigneeCode, 
			String CarrierCode) throws Exception { 
