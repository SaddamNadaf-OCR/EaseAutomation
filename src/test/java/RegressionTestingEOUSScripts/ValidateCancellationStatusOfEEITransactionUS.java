...
public class ValidateCancellationStatusOfEEITransactionUS extends SeleniumTestBase {

	@DataProvider
	public Object[][] getData() {
		return Utility.getData("CancelSEDRequest", excel);
	}

	@Test(dataProvider = "getData")
	public void VerifyCancellationOfEEITransaction(String Testcase, String RunMode, String SBU, String SBUCode,
			String ShipmentWorkStatus, String ShipNumber, String ExportApproved, String uname, String password, String Cancelled) {
