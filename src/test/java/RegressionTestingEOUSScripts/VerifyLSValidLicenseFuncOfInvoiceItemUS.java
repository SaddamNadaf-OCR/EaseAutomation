...
public class VerifyLSValidLicenseFuncOfInvoiceItemUS extends SeleniumTestBase {

	@DataProvider
	public Object[][] getData() {
		return Utility.getData("VerifyValidLicenseInv", excel);
	}

	@Test(dataProvider = "getData")
	public void VerifyInvItemValidLicense(String Testcase, String RunMode, String SBU, String SBUCode,
			...
			String RepairValue, String DiscountRate, String WholesaleRate, String ControllingAgency,
			String ExportClassification, String AuthNo, String AuthItemNo,
			String AuthType, String AuthTxnType, String AuthExpiryDate, String SMEIndicator, String DDTCQty,
			String DDTCUOM, String DDTCRegNo, String validLicense) {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					Invoice_Create_NO_Item.classificationInfoUS(ControllingAgency, ExportClassification);
					Invoice_Create_NO_Item.exportAuthInfo(AuthNo, AuthItemNo, AuthType, AuthTxnType, AuthExpiryDate,
							SMEIndicator);
					Invoice_Create_NO_Item.exportAuthInfo(DDTCQty, DDTCUOM, DDTCRegNo);
					
					Invoice_Create_NO_Item.saveBtn();
					Invoice_Create_NO_Item.selectValidLicense(validLicense);
					Invoice_Create_NO_Item.saveBtn();
					Invoice_Create_NO_Item.verifyValidLicense();
