...
public class SearchAuthorizationExpiringReportUS extends SeleniumTestBase {
	...
	public void AuthExpiringReport(String Testcase, String RunMode, String SBU, String sbu, String AuthType,
			String AuthTypeLink, String AuthNoLink, String AuthNumber, String Country, String Program, 
			String Segment, String Site, String Department  ) {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					AuthExpReport.SearchByParameter(sbu,AuthTypeLink,AuthType,AuthNoLink,AuthNumber,Country,Program,Segment,Site,Department);
