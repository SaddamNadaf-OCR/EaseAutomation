...
public class CreateInvoiceFromAuthUntilShippedStatusUS extends SeleniumTestBase {

	@DataProvider
	public Object[][] getData() {
		return Utility.getData("CreateInvFromAuthTillShip", excel);
	}

	@Test(dataProvider = "getData")
	public void createInvoiceFromAuthUntilShippedStatusUS(String Testcase, String RunMode, String SBU, String SBUCode, String AuthLink,
			String orderNo, String AssignedTo, String ExportDate, String ModeOfTransport, String Program,
			...
			String IncotermPlace, String FreightForwarder, String FrghtFwdCode, String FFStatus, String ChargeDesc,
			String Amount, String ChargingAccnt, String GLA, String containerID, String SealNo, String ConsoPackNo,
			String RadioActAmnt, String DryIceQty, String GrossCartWt, String PackType, String Model, String TareWt,
			String DimensionUOM, String LenghtWidthHight, String WeightUOM, String GrossNet, String SKU, String Class,
			String BOLText, String PackId, String ContainerID, String NoOfPack, String TypeOfPack, String UnitPrice,
			String COO, String InvoiceItem, String CustomsInvoiceQuantity, String ItemUnitPrice, String DDTCQty,
			String DDTCUOM, String HUContainerID, String HUNo, String HSLevel, String GrossWt, String NetWt,
			...
			String DelAttachment, String InvShipmntNo, String ReliefAuthorNo, String RfDueDate, String ReliefActType, 
			...
			String ShipmentApproved, String FrieghtForwarder, String Shipped, String EmailGroup, String EmailDocumentTo, String emailID) {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					Create_Inv.selectFromAuth(SBUCode, AuthLink);
					Create_NInv.invoice_Details(orderNo, AssignedTo, ExportDate, ModeOfTransport);
					...
					Create_NInv.addFreightForwarderForAuthInv(FreightForwarder, FrghtFwdCode, FFStatus);
					...
					Edit_InvItem.clickInvoiceItem(InvOrderNo);
					// Invoice_Create_NO_Item.generalInformation(PartNo, PartNum, Desc,
					// SourceSystemPartNumber, POLineNo,
					// ScheduleAgreement, SerialNumbers, PONumber, CustomerPartNumber,
					// SalesOrderNum,
					// SalesOrderItemNo, DeliveryOrderNo, DeliveryOrderItemNo, PartCOO, Vendor,
					// VendorPN,
					// NetOrderNo, EngineLine, WBS, MTFNumber, Remarks, OrgPONo);
					Invoice_Create_NO_Item.qytPricingInfo(CustomsInvoiceQuantity, ItemUnitPrice);
					// Invoice_Create_NO_Item.classificationInfoUS(ControllingAgency,
					// ExportClassification, HTS,
					// PrimaryUOM);
					Invoice_Create_NO_Item.exportAuthInfo(DDTCQty, DDTCUOM);
					...
					reviewDetails.add_ShipReviewDetails(ShippingDeptReviewer, ShipRegion,
					 ShipSite,
					ExportComplianceReviewer, ExportRegion, ExportSite,
