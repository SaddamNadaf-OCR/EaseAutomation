...
public class VerifyLSScreeningOfInvItemWithITARExemptionUS extends SeleniumTestBase {
	
	
	@DataProvider
	public Object[][] getData() {
		return Utility.getData("VerifyLSITARExempInv", excel);
	}

	@Test(dataProvider = "getData")
	public void VerifyInvItemLicenseScreeningITARExemption(String Testcase, String RunMode, String SBU, String SBUCode,
			...
			String RepairValue, String DiscountRate, String WholesaleRate, String ITARExemption, String DDTCQty, String DDTCUOM, String DDTCEligibleParty, String DDTCRegNo, String LicenseExemption) {
...
//							SMEIndicator);
				Invoice_Create_NO_Item.exportAuthInfo(ITARExemption, DDTCQty, DDTCUOM, DDTCEligibleParty, DDTCRegNo);
				Invoice_Create_NO_Item.selectLicenseExemption(LicenseExemption);
					Invoice_Create_NO_Item.saveBtn();
					Invoice_Create_NO_Item.verifyITARExemption();
