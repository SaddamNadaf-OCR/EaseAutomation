...
public class DeleteAirContract extends SeleniumTestBase{
	
	@DataProvider
	public Object[][] getData() {
		return Utility.getData("DeleteAirContract", excel);
	}
	
	@Test(dataProvider = "getData")
	public void deleteAirContract(String Testcase, String RunMode, String SBU, String ContractCode)throws Exception {
