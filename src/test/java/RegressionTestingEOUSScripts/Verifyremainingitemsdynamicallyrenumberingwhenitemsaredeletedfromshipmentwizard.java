 ...
 * Descriptions : Verify remaining items dynamically renumbering when items are deleted from shipment wizard page
 * changed by : Nil
 * changed date : Nil
...
public class Verifyremainingitemsdynamicallyrenumberingwhenitemsaredeletedfromshipmentwizard extends SeleniumTestBase{
	
	@DataProvider
	public Object[][] getData() {
		return Utility.getData("ItemsDynamicallyRenumbering", excel);
	}

	@Test(dataProvider = "getData")
	public void verifyremainingitemsdynamicallyrenumberingwhenitemsaredeletedfromshipmentwizard(String Testcase, String RunMode, String SBU, 
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					shipmentItems.clickCopyIcon();
					shipmentItems.clickSaveAndReturn();
					shipmentItems.clickCopyIcon();
					shipmentItems.clickSaveAndReturn();
					shipmentItems.clickCopyIcon();
					shipmentItems.clickSaveAndReturn();
					shipmentItems.clickDeleteIcon();
					shipmentItems.itemNumberValidation();
