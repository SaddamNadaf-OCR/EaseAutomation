...
public class VerifyCopyFunctionalityExportInfoCodeUS extends SeleniumTestBase{
	
	@DataProvider
	public Object[][] getData() {
		return Utility.getData("CopyExportInfoCode", excel);
	}

	@Test(dataProvider = "getData")
	public void CopyExportInfoCode(String Testcase, String RunMode, String SBU, String ExportInfoCode) {
