...
public class CreateShipmentTemplateUS extends SeleniumTestBase {

	@DataProvider
	public Object[][] getData() {
		return Utility.getData("CreateShipmentTemplate", excel);
	}

	@Test(dataProvider = "getData")
	public void CreateShipmentTemplate(String Testcase, String RunMode, String SBU, String SBUCode, String TemplateName,
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					String shipID = CreateNewShipTemp.getShipMentTemplateID();
