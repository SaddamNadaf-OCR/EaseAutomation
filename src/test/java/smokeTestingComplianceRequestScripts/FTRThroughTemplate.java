...
public class FTRThroughTemplate extends SeleniumTestBase{
	...
	public void FTRReq(String Testcase, String RunMode, String Template, String BuisnessUnit, String TravelDateFrom, String TravelDateTo,
			...
			String ConsigneeId, String DocumentType, String DocumentDescription, String UploadFile, String DocKeywords,
			String SourceSystemDocNumber, String Notes, String UserFirstName, String EDecision, String Determination,
			String ActivityType, String AuthorizationType, String AgreementNo, String SDecision, String MDecision,
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					Wait.waitfor(3);
					try { additional.click_notapplicable(); Wait.waitfor(3); additional.save();
					Wait.waitfor(3); 
