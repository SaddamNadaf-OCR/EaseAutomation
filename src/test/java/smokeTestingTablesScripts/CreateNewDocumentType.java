...
public class CreateNewDocumentType  extends SeleniumTestBase {

	@DataProvider
	public Object[][] getData() {
		return Utility.getData("createdocumentType", excel);

	}

	@Test(dataProvider = "getData") 
	public void AddDocreq(String Testcase, String RunMode, String SBU, String DocTypeDescription, String SetId, String Status) {
...
//					homepage.movetoDocumentType();	
					Wait.waitfor(2);
					doc.addbutton();
					doc.addbyParameters(DocTypeDescription, SetId, Status);
					doc.savebtn();
					Wait.waitfor(2);
