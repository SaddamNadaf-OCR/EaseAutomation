...
public class CreateScheduleBCode extends SeleniumTestBase {

	@DataProvider
	public Object[][] getData() {
		return Utility.getData("CreateSchBCode", excel);

	}

	@Test(dataProvider = "getData")
	public void CreateScheduleB(String Testcase, String RunMode, String SBU, String Description, String PrimaryUnit)	
	{
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					hz.addbutton();
					Wait.waitfor(2);
					hz.addbyParameters(Description, PrimaryUnit);
					hz.searchbutton();
					Wait.waitfor(2);
