...
public class StandardReqWithMultipleOrgandVisitors extends SeleniumTestBase {
	...
	public void standardrequestmultiple(String Testcase, String RunMode, String SBU, String SelectSBU, String HostSBU,
			...
			String MeetingCategories, String ChargeNumber, String OnLoanDepartment, String OrgName, String OrgType, String Address,
			...
			String Reason, String ChangeRequest, String DateFrom, String DateTo,
			...
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					for (int i = 0; i < title.size(); i++) {
						...
						visitors.add_Individual(title.get(i), fname.get(i), MiddleName, lname.get(i),								vemail.get(i), PhoneNumber);
						visitors.select_OrgzAssociated( company.get(i));
