...
public class DomesticForeignLogicTypeOfPerson extends SeleniumTestBase {
	...
	public void repidRegtn(String Testcase, String RunMode, String SBU, String FromDate, String ToDate, String Site,
			...
			String IssuingState, String ExpirationDate, String Description, String Justification, String WorkflowTypeDomestic) throws Exception {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				//	String vid = visitorInfo.get_RequestID();
					...
					visitorInfo.get_VisitorWorkflowType();
					if(WorkflowTypeDomestic.length() > 0) {
						visitorInfo.validate_Domestic();
					}
					else {
						visitorInfo.validate_Foreign();
					}
	...
	public Object[][] getData() {
		return Utility.getData("DFLogicTypOfPerson", excel);
	}
