...
public class SecurityCheckNotification extends SeleniumTestBase {
	...
	public void standardrequest(String Testcase, String RunMode, String CheckList, String SBU, String SelectSBU,
			...
			String WithSelectedBadgeType, String OverallDecision, String Reason) throws Exception {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					Wait.waitfor(3);
					reviewer.click_SecurityCheckNotification();
					Wait.waitfor(3);
					reviewer.visitorEmail_isDisplayed();
					Wait.waitfor(3);				
					reviewer.click_SendButton();
					Wait.waitfor(3);
					reviewer.click_OKButton();
					Wait.waitfor(3);
	...
	public Object[][] getData() {
		return Utility.getData("SecurityCheckNotification", excel);
	}
}
