...
public class ForeignDomesticLogicStandardTypeOfPerson extends SeleniumTestBase {
	...
	public void standardrequest(String Testcase, String RunMode, String CheckList, String SBU, String SelectSBU,
			...
			String EquipDescription, String EquipJustification, String WorkflowTypeDomestic) throws Exception {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					Wait.waitfor(3);
					visitors.get_VisitorWorkflowType();
					
					//String WorkflowType =visitors.get_VisitorWorkflowType();
					
					if(WorkflowTypeDomestic.length() > 0) {
						visitors.validate_Domestic();
					}
					else {
					visitors.validate_Foreign();
					}
	...
	public Object[][] getData() {
		return Utility.getData("StandardreqLogicTypOfPerson", excel);
	}
}
