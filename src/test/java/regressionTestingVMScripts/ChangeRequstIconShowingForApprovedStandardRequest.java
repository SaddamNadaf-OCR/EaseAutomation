...
public class ChangeRequstIconShowingForApprovedStandardRequest extends SeleniumTestBase 
{
	...
	@Test(dataProvider = "getData")
		...
		public void standardrequest(String Testcase, String RunMode, String CheckList, String SBU, String SelectSBU,
				...
				String DocKeywords, String SourceSystemDocNumber, String Notes, String SecurityUserFirstName, String ReviewerType,
				String ReviewerName, String WithSelectedBadgeType, String OverallDecision, String Reason, String ChangeRequest) throws Exception {
	...
	public Object[][] getData() {
		return Utility.getData("ChangeReqIcon", excel);
	}
}
