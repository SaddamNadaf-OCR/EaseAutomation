...
public class RequestVisitorInfoStandard extends SeleniumTestBase {
		...
		VisitorInformationPage visitorInfo = new VisitorInformationPage(driver, test);
			...
			public void standardrequest(String Testcase, String RunMode, String CheckList, String SBU, String SelectSBU,
					...
					String ClassificationLevel, String VisitPurpose, String DescriptionOfVisit, String MeetingCategories, String ChargeNumber,
				...
				try {
					if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
						...
						if (RunMode.equalsIgnoreCase("y")) {
							...
							Wait.waitfor(3);
							visitors.validate_RequestVisitorInfo();
						} else {
			...
			public Object[][] getData() {
				return Utility.getData("RequestVisitorInfoStandard", excel);
			}
	}
