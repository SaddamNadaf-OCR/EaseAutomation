...
public class KioskRequestCreationReception extends SeleniumTestBase {

	@DataProvider
	public Object[][] getData() {
		return Utility.getData("KioskRequestReception", excel);
	}

	@Test(dataProvider = "getData")
	public void vmctkioskrequest(String Testcase, String RunMode, String SBU, String SBUCode, String SiteID, String KioskWelcomeText, String FirstName,
			String LastName, String Email, String Phone, String VisitorCountry, String VisitorState, String VisitorZip, String VisitorCity, String VisitorAddress,
			String CountryofCitizenship, String TypeOfPerson, String IDType, String IDNumber, String IDCountry, String IDState, String Organization,
			String ORGCountry, String VisitPurpose, String VisitorCategory, String BoxRefNumber, String Vehicleno, String CarMake, String CarModel,
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					KioskSettings.select_KReqVisitorCountry(VisitorCountry);
					KioskSettings.select_KReqVisitorState(VisitorState);
					KioskSettings.type_KReqRegVisitorZip(VisitorZip);
					KioskSettings.type_KReqRegVisitorCity(VisitorCity);
					KioskSettings.type_KReqRegVisitorAddress(VisitorAddress);
					KioskSettings.click_KReqVisitorAddressNext();
					
					KioskSettings.select_KReqCountryofCitizenship(CountryofCitizenship);
					KioskSettings.select_KReqTypeOfPerson(TypeOfPerson);
					KioskSettings.select_KReqIdType(IDType);
					KioskSettings.type_KReqIdNumber(IDNumber);
					KioskSettings.select_KReqIDCountry(IDCountry);
					KioskSettings.select_KReqIDState(IDState);
					KioskSettings.select_KReqVisitPurpose(VisitPurpose);
					KioskSettings.select_KReqVisitorCategory(VisitorCategory);
					KioskSettings.click_KReqCOCNext();
					
					
					KioskSettings.type_KReqOrganization(Organization);
					KioskSettings.select_KReqCountryofORGCountry(ORGCountry);
