...
public class FrontDeskRequestCreation extends SeleniumTestBase {

	@DataProvider
	public Object[][] getData() {
		return Utility.getData("FrontDeskReqCreations", excel);
	}

	@Test(dataProvider = "getData")
	public void repidRegtn(String Testcase, String RunMode, String SBU, String Site, String BuildingName,
			String HostName, String EmailAddress, String HostPhone, String VisitHost, String OrgName, String OrgAddress,
			String OrgType, String Orgcity, String OrgZip, String OrgCountry, String OrgState,
			String RechangeOrgCountry, String RechangeOrgState, String OrgAssociated, String FirstName,
