...
public class ReSendConfirmationRapid extends SeleniumTestBase {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					visitorInfo.validate_ReSendConfirmationpopup();
	...
	public Object[][] getData() {
		return Utility.getData("ReSendConfirmationRapid", excel);
	}
