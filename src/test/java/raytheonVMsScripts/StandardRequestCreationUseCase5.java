...
public class StandardRequestCreationUseCase5 extends SeleniumTestBase {

	@Test(dataProvider = "getData")
	public void standardrequest(String Testcase, String RunMode, String SBU, String SelectSBU,
			...
			String OverallDecision, String Reason, String DocumentDetails, String BusinessUnit) throws Exception {
	...
	public Object[][] getData() {
		return Utility.getData("UseCase5", excel);
	}
}
