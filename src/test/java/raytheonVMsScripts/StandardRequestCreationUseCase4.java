...
public class StandardRequestCreationUseCase4 extends SeleniumTestBase {
	...
	public void standardrequest(String Testcase, String RunMode, String SBU, String SelectSBU, String HostSBU,
			...
			String ExportUserFirstName, String SecurityUserName, String SecurityUserPassword, String OverallDecision,
			String Reason, String DocumentDetails, String UserName, String Password, String BusinessUnit)
			throws Exception {
	...
	public Object[][] getData() {
		return Utility.getData("UseCase4", excel);
	}
}
