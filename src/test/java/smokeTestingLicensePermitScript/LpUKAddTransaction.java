...
public class LpUKAddTransaction extends SeleniumTestBase {
	...
	public void addLPUK(String Testcase, String RunMode, String SBU, String AuthGrantByCountry,
			...
			String GoodsLocIndStatus, String GoodsLocTitle, String GoodsLocSurname, String GoodsLocEmail,
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					Wait.waitfor(3);
					createAuthUK.headerDetailsUnMandatory(ProgramCode, SegmentCode, AuthPurposeStatus, AuthorizationPurposeId);
					...
					if(AuthorizationNo.equalsIgnoreCase("123")) {
					...
					GoodsLocTitle, GoodsLocSurname, GoodsLocEmail, GoodsLocTelephone, GoodsLocIndivotherInfo,
					GoodsLocOrgConsigneeCode, GoodsLocOrgStatus, GoodsLocNatureofBusiness, GoodsLocWebAddress,
					GoodsLocOrgotherInfo);
