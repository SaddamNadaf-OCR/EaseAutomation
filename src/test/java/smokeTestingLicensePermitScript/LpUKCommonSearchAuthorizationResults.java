...
import lpAppUKClasses.SearchAuthorizationsResultsPage;
import utilities.Utility;
import utilities.Wait;

public class LpUKCommonSearchAuthorizationResults extends SeleniumTestBase{

	@DataProvider
	public Object[][] getData() {
		return Utility.getData("LpUKCommonSearchResults", excel);
	}
	...
	public void LpBelgiumStatus(String Testcase,String RunMode,String SBU, String AuthGrantedByCountry,
		...
		HomeLpUKPage                    homelp 			  = new HomeLpUKPage(driver, test);
