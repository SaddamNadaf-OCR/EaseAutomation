...
public class StandardRequestCreationUseCaseVMs1 extends SeleniumTestBase {

	@Test(dataProvider = "getData")
	public void standardrequestusecasevms1(String Testcase, String RunMode, String SBU, String SelectSBU, String HostSBU,
			...
			String DocKeywords, String SourceSystemDocNumber, String Notes, String SecurityUserName,
			String SecurityUserPassword, String OverallDecision, String Reason, String DocumentDetails,String BusinessUnit, String ExpUserName, String ExpUserPassword)
			throws Exception {
			...
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					Wait.waitfor(3);
						...
						login.login(ExpUserName, ExpUserPassword);
						homePage.moveTo_SBUSelection(SBU);
						homePage.click_VisitorManagemtn();
						searchVR.moveTo_Features();
						searchVR.click_WorkQueue();	
	...
	public Object[][] getData() {
		return Utility.getData("UseCase1", excel);
	}
}
