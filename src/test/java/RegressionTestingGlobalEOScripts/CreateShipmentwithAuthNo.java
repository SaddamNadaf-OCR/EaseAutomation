...
public class CreateShipmentwithAuthNo extends SeleniumTestBase {

	@DataProvider
	public Object[][] getData() {
		return Utility.getData("CreateShipmentwithAuthNo", excel);
	}
	...
	public void createShipmentwithAuthorization(String Testcase, String RunMode, String SBU, String SBUcode,
			 String AuthorizationNo ,String ShipmentNo) throws Exception {
