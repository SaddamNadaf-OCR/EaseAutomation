...
public class ReportInvoiceDetails extends SeleniumTestBase {
	...
	public void reportInvoiceDetails(String Testcase, String RunMode, String Sbu, String InvoiceNo, 
			String Status, String ShipmentNo,String PartNo,String partytype, String ShipTO, String BillTO, 
			String EEIValue, String UnitPrice)
			throws Exception {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					Wait.waitfor(2);
					search.parameter(Sbu, InvoiceNo, Status, ShipmentNo, PartNo, partytype, ShipTO, BillTO, EEIValue, UnitPrice);
					Wait.waitfor(2);
					search.search();
					Wait.waitfor(2);
