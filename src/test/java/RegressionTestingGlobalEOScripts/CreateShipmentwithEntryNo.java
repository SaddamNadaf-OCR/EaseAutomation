...
public class CreateShipmentwithEntryNo extends SeleniumTestBase {

	@DataProvider
	public Object[][] getData() {
		return Utility.getData("createShipmentwithentryno", excel);
	}

	

@Test(dataProvider = "getData")
public void createShipmentwithentryno(String Testcase, String RunMode, String SBU, String SBUcode,
		 String entryno, String ShipmentNo) throws Exception {
	...
	try {
		if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
			...
			if (RunMode.equalsIgnoreCase("y")) {
				...
				CreatShip.createshipmentwithEntryNo();
				Wait.waitfor(2);
				CreatShip.entryno(entryno);
