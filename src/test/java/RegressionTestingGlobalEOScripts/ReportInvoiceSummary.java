...
public class ReportInvoiceSummary extends SeleniumTestBase {
	...
	public void reportInvoiceSummary(String Testcase, String RunMode, String Sbu, String InvoiceNo,
			...
			String ShipTo, String BillTo, String UnitPrice, String ECCN, String AuthNo)
			throws Exception {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					Wait.waitfor(2);
					search.parameter(Sbu, InvoiceNo, ShipmentNo, CountryofultDest, PartNo, CountryOfOrigin, 
							partytype, ShipTo, BillTo, UnitPrice, ECCN, AuthNo);
					Wait.waitfor(2);
					search.search();
					Wait.waitfor(2);
