...
public class LpBelgiumCopyRequestAndCreateNewRequest extends SeleniumTestBase {

	@DataProvider
	public Object[][] getData() {
		return Utility.getData("LPBelgiumCopyRequest", excel);
	}

	@Test(dataProvider = "getData")
	public void createNewRequest(String Testcase, String RunMode, String SBU, String AuthGrantByCountry,
			String AuthorizationCode, String RefrenceId, String ProgramCode, String SegmentCode, String Agency,
			String Status, String DocumentType, String UploadfileName, String DocumentLocationPath, String ExporterCode,
			String Country, String CountryType, String PartNo, String consigneeCode, String consigneeType,
			String endUserspecific, String ContractDate, String customsRegime, String additionalInformation,
			String AcknowledgementChkBox, String applicantDate, String FirstAndLastName, String ProviosDescription,
			String Notes, String HDstatusReviewer, String ReviewerUserFirstName, String HDstatusApprovedForSub,
			String HDstatusAgency, String HDstatusAgencyApproved, String AgencyAuthorizationsNo, String AgencyIssueDate,
			String AgencyExpiryDate) throws Exception {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					Wait.waitfor(3);
					endUseSpecificPurpose.additionalInformationPage(ContractDate, customsRegime, additionalInformation);
					...
					searchAuthResults.clickCopybtn();

					String status = createAuth.getStatus();
					if (status.equalsIgnoreCase("In Progress")) {
						test.log(LogStatus.PASS, "Status : " + status);
					} else {
						test.log(LogStatus.FAIL, "Status : " + status);
						testFail();
						softAssertion.assertTrue(false);
					}
