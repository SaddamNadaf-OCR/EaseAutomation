...
public class StandardReqAddHostNewField extends SeleniumTestBase {

	@Test(priority = 6)

	public void NewFiledSReq() throws Exception {
		...
		//		detail.DateofLastComplianceTraining_Displayed();
				Wait.waitfor(3);
				homePage.returnPage();
				Wait.waitfor(3);
			}
