...
public class OrganizationForeignInterestSaveIssue30010 extends SeleniumTestBase {
	...
	public void standardrequest() {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				visitors.addRepresentingForeignInterest(propVMs.getProperty("OrgName"), propVMs.getProperty("Country"));
				Wait.waitfor(3);
				homePage.returnPage();
				Wait.waitfor(4);
			}
