...
public class UpdatetheEmailAddressOfTheVisitor30237 extends SeleniumTestBase {
	...
	public void standardrequest() {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				Wait.waitfor(3);
				visitors.validateEditEmail(propVMs.getProperty("FirstName"), propVMs.getProperty("UpdateEmail"));
