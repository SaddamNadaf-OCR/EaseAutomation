...
public class AddVisitorToVisitorResultGrid29913 extends SeleniumTestBase {
	...
	public void standardrequest() {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				Wait.waitfor(3);
				visitors.validateAddVisitorGrid(propVMs.getProperty("OrgName"), propVMs.getProperty("OrgType"),
						propVMs.getProperty("City"), propVMs.getProperty("Zip"), propVMs.getProperty("Country"),
						propVMs.getProperty("State"), propVMs.getProperty("CountryOfIncorporation"),
						propVMs.getProperty("Title"), propVMs.getProperty("FirstName"),
