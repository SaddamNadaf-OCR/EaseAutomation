...
public class CreateNewShipment extends SeleniumTestBase {
	...
	public void Shipment(String Testcase, String RunMode, String SBU, String SBUcode, String ShipmentNo,
			String UltDestination, String DutyReliefType, String ReliefAuthorizationNo, String ReliefActivityType,
			String DueDate, String ExporterCode, String ConsigneeId, String MarkingsContainerID, String SealNumber,
			String ConsolidatedPackNumber, String Hazardous, String RadioActivityAmnt, String DryIce,
			String GrossCartonWeight, String PackageType, String Model, String TareWeight, String DimensionUOM,
			String LenghtWidthHight, String WeightUOM, String GrossNet, String SKUQuantity, String Class, String PartNo,
			String ManufacturerID, String CountryOfOrigin, String CountryOfOriginType, String FTAApplicable,
			String NetworkOrderNumber, String EngineLine, String MTFNumber, String CustomsInvoiceQuantity,
			String QuantityUOM, String ItemUnitPrice, String ItemUnitPriceCurrency, String RepairValue,
			String DiscountRate, String WholesaleRate, String ControllingAgencycode, String ExportClassificationItem,
			String HtsAndPrimaryUMO, String SecondaryCustomsQuantity, String SecondaryCustomsQuantityUOM,
			String ImportHTS, String ImportUOM, String USExportECCN, String StatisticalCode, String BISLicenseException,
			String AuthorisationNo, String AuthorisationItemNo, String InternalAuthNo, String AuthorisationExpiryDate,
			String MLCategoryCode, String EUSNo, String AdditionalAuthorisationNo, String AdditionalAuthorisationItemNo,
			String PackingInfo, String HUNoContainerID, String HUNoSubLevel, String GrossWeight, String NetWeight,
			...
			String M_TypeOfPacking, String M_QuantityUOM, String M_AlternateUOM, String BatchNumber,
			String BatchInfoCountryOfOrigin, String BatchInfoQuantity, String BatchInfoExpiryDate,
			String BatchInfoSterilityDate, String ImportShipmentType, String InbondCode, String EntryNo, String ItemNO,
			String ImportIdentificationNo, String RateofYield, String ReExportReliefAuthorizationNo,
			String SearchHazardClassorDivision, String HazmatIdentifactionNumber, String HazmatClass,
			String HazmatDivision, String HazmatGroup, String HazmatPackingInstruction, String HazmatAuthorisation,
			String HazmatNoAndKindOfPack, String HazmatGrossWeight, String HazmatNetWeight, String HazmatCube,
			String SubcomponentItemNo, String ProductNo, String TransportCountryOfOrigin, String TransportPortOfExport,
			...
			String InstDimension, String InstTotalShipmentWeight, String SkipWatchListScreening,
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					CreateNewShp.shipHeaderInfo(ShipmentNo, UltDestination, "", "", "", "", "", "", "", "", "", "",
							DutyReliefType, ReliefAuthorizationNo, ReliefActivityType, DueDate);
