...
public class ReportShipmentAgainstLic extends SeleniumTestBase {
	...
	public void reportShipmentAgainstLic(String Testcase,String RunMode, String Sbu, 
			String AuthorizationNo, String LicenseType, String UltDestination)throws Exception {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					Wait.waitfor(2);
//					search.parameter(Sbu,AuthorizationNo,LicenseType,UltDestination);
					Wait.waitfor(2);
					search.search();
					Wait.waitfor(2);
