...
public class CreateNewSalesOrderTransaction extends SeleniumTestBase {
	...
	public void SalesOrder(String Testcase, String RunMode, String SBU, String SBUCode, String orderNo, String ultDest,
			String ModeOfTransport, String EntityType, String entityCode, String Status, String ContainerID,
			String DimensionUOM, String LenghtWidthHight, String WeightUOM, String GrossNet, String ProductDesc,
			String COO, String CustInvQty, String UOM, String UnitPrice, String ExportClassification, String HTS,
			String PrimaryUOM, String USExport, String AuthNo, String AuthItemNo, String AuthType, String AuthTxnType,
			String AuthExpiryDate, String AdditionalAuthNo, String AdditionalAuthItemNo, String HUContainerID,
			String BatchNo, String BatchCOO, String hazmatID, String SubCompNo, String ParentProdID) {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					SalesCreate_NO_Item.classificationInfo(ExportClassification, HTS, PrimaryUOM, USExport);
					SalesCreate_NO_Item.classificationInfoSaveBtn();
					SalesCreate_NO_Item.exportAuthInfo(AuthNo, AuthItemNo, AuthType, AuthTxnType, AuthExpiryDate);
				//	SalesCreate_NO_Item.additionalAuthInfo(AdditionalAuthNo, AdditionalAuthItemNo);
