...
public class SearchInvoice extends SeleniumTestBase {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					invoice.search_InvNo(InvoiceNo);
					invoice.search_WorkStatus(WorkStatus);
					/*invoice.searchInvoiceHeader(InvoiceNo, WorkStatus, ShipmentNo, LSStatus);
					invoice.searchInvoiceItem(PartNo, Description);
					invoice.searchEC(ExportClassification, AuthorisationNo);*/
