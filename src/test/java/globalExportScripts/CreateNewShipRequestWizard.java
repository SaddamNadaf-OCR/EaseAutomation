...
import globalExportClasses.ShipWizardQuestionnairePage;
...
public class CreateNewShipRequestWizard extends SeleniumTestBase {
	...
	public void ShipmentWizard(String Testcase, String RunMode, String SBU, String SBUcode, String ShipmentNo,
			...
			String FFCode, String IntConsigneePartyType, String EndUser, String MarkingsContainerID, String SealNumber,
			...
			String LenghtWidthHight, String WeightUOM, String GrossNet, String SKUQuantity, String Class,
			String BOLText, String PaymnetID, String IncotermCode, String DontPayInvoice,
			String IncoNamedforDestination, String ForCustomsPurpose, String Notes, String EntryType,
			String ConsigneeIdBillTo, String CartonDimensionUOM, String CartonLenghtWidthHight, String CartonWeightUOM,
			String CartonGrossNet, String PartNo, String MLCategoryExportClassification, String TariffCode,
			String ExportClassification, String ImportHTSUOM, String USExportClassificationECCN, String SalesOrderNo,
			String SalesOrderItemNo, String DeliveryOrderNo, String DeliveryOrderItemNo, String SerialNumbers,
			String CustomsInvoiceQuantity,String Units, String QuantityOrdered, String TotalItemValue, String DiscountRate,
			...
			String BatchQuantity, String BatchExpiryDate, String BatchSterilityDate, String FreightChargesPaidBy,
			String CustomDutiesPaidBy, String ForeignVATPaidBy, String InsuranceRequired,
			String ShipmentContainsPersonalInfo, String CostCenterNo, String LineofBusinessSupported,
			String ModeofTransportation, String ManagertoApproveFreight, String POReferenceNo,
			String SpecialInstructions, String ShipmentSpecialInstructions, String AttachedDocuments,
			String ChargeDescription, String Amount, String ChargingAccount, String GLACode, String ChargeToCustomer,
			String WholesalerCharge, String PrintOnDocuments, String ExportClasfctnECCN, String AuthorizationNo,
			String MLCategory, String RegistrationNo, String LicenseException, String ITARExemption,
			String RegulatoryCitation, String TSCAReachInfoQuestion, String TSCAReachInfoAnswer, String DocumentType,
			String UploadfileName, String DocumentLocationPath, String ShippingDeptReviewer, String ExportComplianceReviewer, String TransportGatekeeperExportOps) throws Exception {
		...
		ShipWizardQuestionnairePage Questionnaire = new ShipWizardQuestionnairePage(driver, test);
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					ShipNoInfo.partiesToTheTransaction(ExporterCode, ConsigneeId, FFCode, IntConsigneePartyType,
							EndUser);
...
//							DiscountRate, WholesaleRate);
					...
					ShipNoInfo.clickQuestionnaireIcon();
					Questionnaire.click_NotApplicable();
					Questionnaire.click_SaveAndProceed();
					Wait.waitfor(3);
