...
public class CreateNewShipment extends SeleniumTestBase {
	...
	public void Shipment(String Testcase, String RunMode, String SBU, String SBUcode, String ShipmentNo,
			String UltDestination, String DateOfExport, String Region, String SLIDate, String SiteID, String Segment,
			String Program, String ProductFamily, String MotId, String DateofArrival, String ReportMonthAndYear,
			String DutyReliefType, String ReliefAuthorizationNo, String ReliefActivityType, String DueDate,
			String ExporterCode, String ConsigneeId, String FFCode, String IntConsigneePartyType,
			String TravelerUserFirstName, String TravelerName, String TravelerEmail, String TravelerPhone,
			String FreightChargesPaidBY, String CustomDutiesPaidBy, String ForeignVatPaidBy, String CostCeneterNo,
			String LineOfBusinessSupport, String EquipmentNo, String SealNo, String MarkingsContainerID,
			String SealNumber, String ConsolidatedPackNumber, String Hazardous, String RadioActivityAmnt, String DryIce,
			String GrossCartonWeight, String PackageType, String Model, String TareWeight,
			String DimensionUOM, String LenghtWidthHight, String WeightUOM, String GrossNet, String SKUQuantity,
			String Class, String PartNo, String ManufacturerID, String CountryOfOrigin, String CountryOfOriginType,
			String FTAApplicable, String NetworkOrderNumber, String EngineLine, String MTFNumber,
			...
			String StatisticalCode, String BISLicenseException, String AuthorisationNo, String AuthorisationItemNo,
			String InternalAuthNo, String AuthorisationExpiryDate, String MLCategoryCode, String EUSNo,
			String AdditionalAuthorisationNo, String AdditionalAuthorisationItemNo, String PackingInfo,
			...
			String ComplianceCertificateText, String InstructIncoterm, String IncoNamedForDestination,
			String NextFlightOut, String InstConsolidateShip, String InstInsuranceRequired, String InstNoofPackages,
			String InstDimension, String InstTotalShipmentWeight, String ReviewerFirstName, String ShippingDeptReviewer,
			String ExportComplianceReviewer, String TransportGatekeeperExportOps, String SkipWatchListScreening,
			...
			String UnitPrice, String TotalPrice, String CountryofOrigin, String ShippingPoint, String AirwayBillNumber,
			String BillOfLading, String MaterialGroup, String MiscHazmatHazardous, String InBondCode, String BondNumber,
			String MiscHazmatGrossWeight, String RoutingCode1, String RoutingCode2, String ShipmentType,
			String CertificateofRegistration, String Specify, String TransactionSMECode, String RegisterNo,
			String MiscGLACode, String SourceCode, String IRequestorUserName, String IRequestorUserTitle,
			String IRequestorTelephone, String IRequestorEmail, String IRequestorPickedBy, String IRequestorLoadedBy,
			String IRequestorCustomerServiceRep, String Status) throws Exception {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					CreateNewShp.shipHeaderInfo(ShipmentNo, UltDestination, DateOfExport, Region, SLIDate, SiteID,
							Segment, Program, ProductFamily, MotId, DateofArrival, ReportMonthAndYear, DutyReliefType,
					...
					NewItem.AddGeneralInformation(PartNo, "SourceSystemPartNumber", "SerialNumbers", "PONumber",
					...
					NewItem.addClassifacationInfo(ControllingAgencycode, ExportClassificationItem, HtsAndPrimaryUMO,
							...
							StatisticalCode);
					NewItem.addExportAuthorisationInfo(BISLicenseException, AuthorisationNo, AuthorisationItemNo,
							InternalAuthNo, AuthorisationExpiryDate, MLCategoryCode, EUSNo);
					NewItem.addAdditionalAuthorization(AdditionalAuthorisationNo, AdditionalAuthorisationItemNo);
					...
					Instruction.add_BookingDetailsandMisTerms(InstructIncoterm, IncoNamedForDestination,
							"InstMasterAWBNumber", "HouseAirwayBillNumber", NextFlightOut, InstConsolidateShip,
							InstInsuranceRequired, "12000", "", "", InstNoofPackages, InstDimension,
							InstTotalShipmentWeight);
					Instruction.click_save();
					Wait.waitfor(3);
					CreateNewShp.select_Questionnaire();
					questionnaire.click_NotApplicable();
					CreateNewShp.select_ReviewerDetails();
					Reviewer.add_ShipReviewDetails(ReviewerFirstName, ShippingDeptReviewer, ExportComplianceReviewer,
					...
					Invoice.addContainerPackingDetails(MarkingsContainerID, SealNumbers, ConsolidatedPackNumber,
							...
							Model, TareWeight, DimensionUOM, LenghtWidthHight, WeightUOM, GrossNet, SKUQuantity,
							HazmatClass, "BOLText");
					...
					Invoice.select_MiscellaneousDetails();
					Misc.addShipmentDetails(ShippingPoint, AirwayBillNumber, BillOfLading, MaterialGroup,
							MiscHazmatHazardous, InBondCode, BondNumber, MiscHazmatGrossWeight, TotalNetWeight,
							RoutingCode1, RoutingCode2, ShipmentType);
					Misc.addCertificateOfReg(CertificateofRegistration, Specify);
					Misc.addAccountingInfo(TransactionSMECode, RegisterNo, MiscGLACode, SourceCode);
					Misc.click_SaveMiscellaneousDetails();
					Wait.waitfor(3);
					...
					Wait.waitfor(3);
					// Instructions.select_CustomsFilingDetails();
					...
					for (int i = 0; i < status.size(); i++) {
						CreateNewShp.click_ChangeStatus(status.get(i));
						Wait.waitfor(2);
