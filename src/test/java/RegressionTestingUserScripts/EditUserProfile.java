...
public class EditUserProfile extends  SeleniumTestBase{
	@DataProvider
	public Object[][] getData() {
		return Utility.getData("editUserProfile", excel);
	}
	
	@Test(dataProvider = "getData")
	public void editUserProfile(String Testcase, String RunMode, String SBU ,String UserId, String firstname, String lastname, String EmailId, String UserGroup, String SBUcode,
			String AccountNo,String Directuser,String Portaluser,String EmployeeId,String ModuleList,String Permission,String Interface,String UserId1,String firstname1,
			String lastname1,String UserTitle1,String UserGroup1,String PrimarySBU1,String Dateformat1,String Numberformat1,String Email1,String Password ) throws Exception {
		//Object Creation
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					Wait.waitfor(2);
					userprofilepage.ClickUserId();
					Wait.waitfor(2);
					createUserPage.title_isDisplayed();
					Wait.waitfor(2);
					...
					Wait.waitfor(2);
					userprofilepage.titleIsDisplayed();
					Wait.waitfor(2);
					userprofilepage.userIsDisplayed();
				    Wait.waitfor(2);
