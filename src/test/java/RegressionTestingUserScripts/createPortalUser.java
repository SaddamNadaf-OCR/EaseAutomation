...
public class createPortalUser extends SeleniumTestBase{
		@DataProvider
		public Object[][] getData() {
			return Utility.getData("createPortalUser", excel);
		}

		@Test(dataProvider = "getData")
		public void CreatePortalUser(String Testcase, String RunMode, String SBU ,String UserId, String firstname, String lastname, 
				String UserTitle, String UserGroup, String PrimarySBU, String Dateformat, String Numberformat, String PortalUser, String Email ,String PortalDomain, String Password) throws Exception {
			//Object Creation
			...
			try {
				if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
					...
					if (RunMode.equalsIgnoreCase("y")) {
						...
						Wait.waitfor(5);
						createUserPage.AddPortalUser(UserId, firstname, lastname, UserTitle, UserGroup, PrimarySBU, Dateformat, Numberformat,PortalUser, Email, PortalDomain);
						Wait.waitfor(5);
