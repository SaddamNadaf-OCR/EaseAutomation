...
public class SearchExdsAuditStatusReportUS extends SeleniumTestBase {
	...
	public void ExdsAuditReport(String Testcase, String RunMode, String SBU, String SbuCode, String RefNo, String WorkStatus) {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					ExdsReport.selectSBU(SbuCode);
					ExdsReport.enterRefNo(RefNo);
					// ExdsReport.selectFormType(FormType);
					ExdsReport.selectWorkStatus(WorkStatus);
