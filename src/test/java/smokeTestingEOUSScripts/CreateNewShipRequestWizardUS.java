...
public class CreateNewShipRequestWizardUS extends SeleniumTestBase {
	...
	public void ShipmentWizard(String Testcase, String RunMode, String SBU, String SBUcode, String ShipmentNo,
			String PhoneNo, String TrackingNo, String UltDestination, String ExporterCode, String ConsigneeId,
			 String MarkingsContainerID, String SealNumber,
			...
			String RegulatoryCitation, String TSCAReachInfoQuestion, String TSCAReachInfoAnswer, String ShippingDeptReviewer, String ExportComplianceReviewer, String TransportGatekeeperExportOps) throws Exception {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					Wait.waitfor(3);
					Items.click_AddItem();
					Items.addItemGeneralInfo(PartNo, MLCategoryExportClassification, TariffCode, ReportingClassification,
					...
					Items.clickSaveBtn();
					Items.addQuantityAndPricingInfo(CustomsInvoiceQuantity,Units, UnitPrice, QuantityOrdered, TotalItemValue,
				...
				//			BatchSterilityDate);
					...
					ExportClassiftn.addExportClassificationsUS(ExportClasfctnECCN, AuthorizationNo, MLCategory,
