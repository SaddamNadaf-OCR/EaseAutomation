...
public class SearchAESStatusChangeReportUS extends SeleniumTestBase {
	...
	public void AESReport(String Testcase, String RunMode, String SBU, String SBUCode, String AESStatus) {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					AESReport.selectSBUCode(SBUCode);
					AESReport.selectAES(AESStatus);
					AESReport.SearchBtn();
