...
public class ShipmentWLSAuditReportUS extends SeleniumTestBase{
	...
	public void ShpWLSAuditReport(String Testcase, String RunMode, String SBU, String sbu, String ShpNo ) {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					ShpWlsReport.selectSBU(sbu);
					ShpWlsReport.enterShpNo(ShpNo);
