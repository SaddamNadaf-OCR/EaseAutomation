...
public class CreatePLFromShipNoUS extends SeleniumTestBase {
	...
	public void createPLFromShipmentNo(String Testcase, String RunMode, String SBU, String ShipNo) {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					ShipPage.enterShipNo(ShipNo);
					ShipPage.shipment_SearchBtn();
//					ResultShipPage.select_ShipmentNo(ShipNo);
					Wait.waitfor(2);
