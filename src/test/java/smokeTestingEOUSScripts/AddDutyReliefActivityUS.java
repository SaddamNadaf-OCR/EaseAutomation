...
public class AddDutyReliefActivityUS extends SeleniumTestBase {
	...
	public void addDutyRActivity(String Testcase, String RunMode, String SBU, String ReliefType,
			String DutyReliefAuthorizationNo, String AutorizationsNo, String ShipmentType, String TransactionDate,
			String ReferenceNo, String ReferenceItemNo, String DueDate, String Description, String Quantity, String UOM)
			throws Exception {
