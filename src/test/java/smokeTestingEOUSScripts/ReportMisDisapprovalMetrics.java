...
public class ReportMisDisapprovalMetrics extends SeleniumTestBase {
	...
	public void reportMisDisapprovalMetrics(String Testcase,String RunMode, String SBU, String ReportType, String Sbu, String ShipmentWorkStatus)
			throws Exception {
			...
			try {
				if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
					...
					if (RunMode.equalsIgnoreCase("y")) {
						...
						Wait.waitfor(2);
						search.parameter(ReportType,Sbu,ShipmentWorkStatus);
						Wait.waitfor(2);
						search.search();
						Wait.waitfor(2);
