...
public class GtcNewScreeningWithWatchListAndExportLicense extends SeleniumTestBase {

	@DataProvider
	public Object[][] getData() {
		return Utility.getData("CreatingWatchListAndExpotScreen", excel);
	}
	...
	public void createScreening(String Testcase, String RunMode, String ClientReferenceNo, String ExportCountry,
			...
			String EntityDecision, String DispositionReason, String Remarks, String ControlDecision,
			String ImportStatus, String ImportRemarks) throws Exception {
			...
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					newscreen.entityDetails(SourceFile, ConsigneeId, EntityName, EntityAddress1, EntityAddress2,
							...
							EntityStatus);
					Wait.waitfor(5);
					newscreen.itemDetails(PartNo, ECCNumber, ClassificationItem, UnitPrice, Quantity, UOM, Value,
							AuthorizationType, Currency, CountryOfOrigin, Enduse, EndUserType);
					newscreen.click_addItembutton();
					newscreen.click_screenbtn();
					// newscreen.click_licensescreeningbtn();
					// newscreen.click_documentationrequirementbtn();
					...
					if (StatusApproved.equals("Approved")) {
						...
						// screen.select_GtcExportException();
						// screen.click_GtcExportLicenseScreeningSubmit();
						screen.click_GtcImportControlScreening();
						screen.click_GtcImportControlDetails(ImportStatus, ImportRemarks);
						screen.click_GtcImportControlSave();
						screen.click_documentationrequirementbtn();
