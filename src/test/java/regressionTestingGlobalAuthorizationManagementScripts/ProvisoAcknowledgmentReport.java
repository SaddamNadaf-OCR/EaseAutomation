...
public class ProvisoAcknowledgmentReport extends SeleniumTestBase{
	
	@DataProvider
	public Object[][] getData(){
		return Utility.getData("ProvisoAcknowledgmentReport", excel);
	}
	
	@Test(dataProvider="getData")
	public void provisoAcknowledgmentReport(String TestCases, String RunMode, String SBU, String SBUCode, 
