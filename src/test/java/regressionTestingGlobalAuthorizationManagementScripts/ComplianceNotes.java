...
public class ComplianceNotes extends SeleniumTestBase{
	...
	public void complianceNotes(String TestCases,String RunMode,String SBU,String ReferanceNO,String date,String notesID,String code,
			String purpose, String contactType, String authorizationtype, String priority,String securityClassName, 
			String transactionID, String country, String productfamilyID,String Programcode,String programtextbox,
			String SegmentCode,String segmentTextbox,String ProductLineID,String usgOfficer,
			String usgPhoneNo,String usgEmail,String userFirstname,String userFirstname1,String selectList,
			String issueSummary,String description,String memo) {
