 ...
 * Descriptions : Add Import Request Template
 * changed by : Nil
 * changed date : Nil
...
public class AddImportRequestTemplate extends SeleniumTestBase{
	
	@DataProvider
	public Object[][] getData() {
		return Utility.getData("AddIRTemplates", excel);
	}
	
	@Test(dataProvider ="getData")
	public void importRequestTemplate(String Testcase, String RunMode, String templateName, String BusinessUnit, String ImportRequiredDate,
		...
		try {
			if(!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if(RunMode.equalsIgnoreCase("y")) {
					...
					Wait.waitfor(3);
					importReq.add_template(templateName);
					...
					homepage.ImportReqTemplate();
					searchPage.SearchByTemplatename(requestID);
					searchPage.Search();
