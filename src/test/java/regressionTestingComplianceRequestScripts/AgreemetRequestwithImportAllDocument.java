 ...
 * Descriptions : Import Documents in Agreement Request
 * changed by : Nil
 * changed date : Nil
...
public class AgreemetRequestwithImportAllDocument extends SeleniumTestBase{
	
	@DataProvider
	public Object[][] getData() {
		return Utility.getData("AgreementReqImportDoc", excel);
	}
