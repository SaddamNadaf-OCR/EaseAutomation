...
//Added By Saddam
//on 03/04/2024
//Import All Documents for Import Request
...
import crsClasses.ImportIntoAgreementPage;
...
public class ImportRequestWithImportAllDocuments extends SeleniumTestBase{
	
	@DataProvider
	public Object[][] getData() {
		return Utility.getData("ImportRequestDocImport", excel);
	}
	...
	public void ImportReq(String Testcase, String RunMode, String SBU, String BusinessUnit, String ImportRequiredDate,
			...
			String ApproverPhone, String Priority, String LicenseType, String SbuID) throws Exception {
		...
		ImportIntoAgreementPage importPage = new ImportIntoAgreementPage(driver, test);
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					importReq.importIntoLicenseApplication();
					Wait.waitfor(3);
