...
public class AuthorisationDetailsReportSearchResult extends SeleniumTestBase{
	...
	public void authorisationsearchpage(String Testcase, String RunMode, String SBU, String SBUCode, String ReferenceID, String Status, 
			String FolderID, String AuthorizationCode, String AuthorizationNo, String AuthorizationCountry, String Code, String AgencyCode, 
			String ProgramCode, String SegmentCode, String RequestorName, String ReviewerName, String SubmitReviewDateFrom, 
			String SubmitReviewDateTo, String ReviewCompletedDateFrom, String ReviewCompletedDateTo, String ApplicationSubmitDateFrom, 
			String ApplicationSubmitDateTo, String IssueDateFrom, String IssueDateTo, String ExpiryDateFrom, String ExpiryDateTo,
