...
public class CreateNewProduct extends SeleniumTestBase {
	...
	public void CreateProduct(String Testcase, String RunMode, String SBU, String PartNo, String SKUNo,
			String Description, String NationalStockNumber, String ProductLine, String Program, String CommodityType,
			String Site, String ProductName, String PlantId, String ModelNo, String NetWeight,
			String SchedulingAgreement, String UOMForPrice, String FlagReason, String MaterialType, String UnitPrice,
			String Currency, String SecurityClassification,String Segment, String HazardousMaterial, String CompIsDesAuth,
			String IsraelFTACertified, String SourceSystemId, String SourceSystemPartNo, String Tsca12bCode,
			String MSDSNumber, String CASNumber,String CountryName, String EClassification,String ExportclassDate, String Jurisdiction, String ControllingAgency,
			String prevECCNNO, String OCRCode, String NewECCNNO,String MethodOfDetermination, String RationaleForClassification, String ExpAuthority,String HSCode,
			String SchBClassification,String USMILClass, String Rationale, String GRI,
			String ChapterSectionNotes, String ExplanatoryNotes, String Remarks,String AcceptYes, String dateaccept, String ManufacturerCode,
			String CountryOfOrigin, String ContactName, String ContactEmail, String JurisdictionDet,
			String CountryOfClassification, String ExportClassification, String ScheduleB, String HTSUnit,
			String HTSCode, String ADCVDCountry, String ADCVDCaseType, String ADCVDCaseNo, String ADCVDEfDateFrom,
			String ADCVDEfDateTo, String CountryContent, String TradePrgCountry, String FTACode, String Eligible,
			String SubCompPartNo, String QuantCalcMethod, String QuantityUsed, String QuantityAppearing,
			String HazmatId, String FlashPointTemp, String HazContactName, String HazPhone, String DocType,
			String DocDesc, String UploadfileName, String Notes, String Comments) {
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				expclass.ScrolltoExpControldetails();
					Wait.waitfor(3);
					expclass.ExportAuthority(ExpAuthority);
					//expclass.StatClassDetailheader();
					expclass.save();
					Wait.waitfor(3);
