...
public class ProductReport extends SeleniumTestBase {
	...
	public void SearchProductReport(String Testcase, String RunMode, String SBU, String SBUCode, String Status,
		...
		try {
			if (!Utility.isExecutable(getClass().getSimpleName(), excel)) {
				...
				if (RunMode.equalsIgnoreCase("y")) {
					...
					Wait.waitfor(5);
					searchp.searchProductDetails(SBUCode, Status, PartNo, SKUNo, PartNoManuf, SourcePartNo,
